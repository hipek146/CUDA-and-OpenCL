...
int main(int argc, char** argv)
{
    ...
    float*       h_c = (float*) calloc(LENGTH, sizeof(float));       // b vector
    float*       h_d = (float*) calloc(LENGTH, sizeof(float));       // b vector
    float*       h_e = (float*) calloc(LENGTH, sizeof(float));       // b vector
    float*       h_g = (float*) calloc(LENGTH, sizeof(float));       // b vector
    float*       h_f = (float*) calloc(LENGTH, sizeof(float));       // c vector (a+b) returned from the compute device
    ...
    cl_mem d_c;                     // device memory used for the input  b vector
    cl_mem d_d;                     // device memory used for the input  b vector
    cl_mem d_e;                     // device memory used for the input  b vector
    cl_mem d_g;                     // device memory used for the input  b vector
    cl_mem d_f;                     // device memory used for the output c vector
    ...
    // summarise results
    printf("C = A+B D=C+E F=D+G RETURN F:  %d out of %d results were correct.\n", correct, count);
