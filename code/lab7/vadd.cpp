...
int main(void)
{
    std::vector<double> h_a(LENGTH);                // a vector 
    std::vector<double> h_b(LENGTH);                // b vector 	
    std::vector<double> h_c(LENGTH);                // b vector 	
    std::vector<double> h_d(LENGTH);                // b vector 	
    std::vector<double> h_e(LENGTH);                // b vector 	
    std::vector<double> h_g(LENGTH);                // b vector 	
    std::vector<double> h_f(LENGTH, 0xdeadbeef);    // c = a + b, from compute device
    ...
    try 
    {
        ...
        d_c   = cl::Buffer(context, h_b.begin(), h_b.end(), true);
        ...
        d_f  = cl::Buffer(context, CL_MEM_WRITE_ONLY, sizeof(double) * LENGTH);
